...
export const x_snc_nrt_travel_request = Table({
    ...
    schema: {
        ...
        destination_city: StringColumn({ label: 'Destination City', maxLength: 100 }),
        destination_country: StringColumn({ label: 'Destination Country', maxLength: 100 }),
        departure_date: DateColumn({ label: 'Departure Date', mandatory: true }),
        return_date: DateColumn({ label: 'Return Date', mandatory: true }),
        estimated_cost: DecimalColumn({ label: 'Estimated Cost' }),
        actual_cost: DecimalColumn({ label: 'Actual Cost' }),
        ...
        requires_visa: BooleanColumn({ label: 'Requires Visa' }),
