...
declare class GlideSession {
    ...
    getTimeFormat(style?: string): string;
...
declare class GlideTime extends GlideDateTime {
    ...
    setDisplayValueEx(time?: string, style?: string): void;
    setDisplayValueLang(time?: string, style?: string, language?: string): void;
    /**
     * Gets the time in the current user's display format and time zone
     */
    getDisplayValue(): string;
    getDisplayValueEx(style?: string): string;
...
declare class GlideUser {
    ...
    getTimeFormat(): string;
    getTimeFormatEx(style?: string): string;
...
declare class GlideElement {
    ...
    getStorageValue(arg?: any): string;
    ...
    getDynamicAttribute(): any;
    hasValidValue(target?: any): boolean;
    isInSchema(): boolean;
    isTransient(): boolean;
    hasDefinition(): boolean;
    getDynamicNamespace(): any;
    getDynamicNamespaceName(): any;
}
/**
...
declare class GlideDateTime extends AGlideObject {
    ...
    setDisplayValueEx(asDisplayed?: string, style?: string): void;
...
declare interface GlideRecordGenerated {
    ...
    /**
     * Retrieves the error message generated by the last blocked cross-scope reference attempt.
     */
    getLastCrossScopeReferenceError(): string;
    clearLastCrossScopeReferenceError(): void;
    /**
...
declare class DynamicSchemaAPI {
    ...
    jsFunction_dropVirtualColumnsForStore(tableName?: string, storeColumnName?: string): boolean;
    getSupportedInternalTypes(): NativeArray;
    ...
    getCopyApi(categoryToCopy?: string, verificationKey?: string): CopyDynamicSchemaAPI;
    constructor();
}
/**
...
declare interface GlideAggregateGenerated extends ㅤGlideRecord {
    ...
    setAggregateFollowRef(b?: boolean): void;
    ...
    setAggregateWorkflow(workflow?: boolean): void;
    setWorkflow(workflow?: boolean): void;
