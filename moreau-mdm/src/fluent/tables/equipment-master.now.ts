...
export const x_snc_eqmdm_equipment_master = Table({
    name: 'x_snc_eqmdm_equipment_master',
    label: 'Equipment Golden Master',
    autoNumber: { prefix: 'EQM', number: 1000, numberOfDigits: 7 },
    schema: {
        ...
        acquisition_value: DecimalColumn({ label: 'Acquisition Value' }),
